<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImageGrid.ascx.cs" Inherits="RealEstateDemo.ImageGrid" %>
<asp:ListView runat="server" ID="ImageListView" ItemPlaceholderID="itemPlaceHolder" 
     GroupPlaceholderID="groupPlaceHolder" OnItemCommand="ImageListView_ItemCommand" OnSelectedIndexChanged="ImageListView_SelectedIndexChanged">
    <LayoutTemplate>
        <h1>
